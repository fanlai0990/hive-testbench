...
public class H {
    public static void main( String[] args ) {
        ...
        Path fin = Paths.get("../log_tpch_bin_partitioned_orc_2");
        Path fout = Paths.get("./log_tpch_2_shuffle");
        ...
        Path fi = fout;
        Path fo = Paths.get("./log_tpch_2_shuffle_largest");
        ...
        Path fii = fo;
        Path foo = Paths.get("./log_tpch_2_shuffle_largest_h");
